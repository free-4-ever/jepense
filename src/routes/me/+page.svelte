...
<div class="f-ll">
	<div class="row items-x-cente ai-c">
		...
		<ul class="">
			<li>Name: <span class="f-marck f-lll"> Ali (Bardiya) Bakhshandeh </span></li>
	...
	<div>
		...
		<div class="column my-lg">
			<h4>🍷 Interests</h4>
			I love programming, web and game development in the CS field. Also have an active interest in world
			literature, philosophy, spirituality and a lot more!
		</div>
		<div class="column my-lg">
			<h4>🎓 Education</h4>
			<ul class="my-n">
